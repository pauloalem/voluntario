...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field areas on 'Beneficiario'
        db.delete_table('core_beneficiario_areas')

        # Removing M2M table for field areas on 'Voluntario'
        db.delete_table('core_voluntario_areas')

        # Deleting field 'Usuario.nascimento'
        db.delete_column('core_usuario', 'nascimento')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field areas on 'Beneficiario'
        db.create_table('core_beneficiario_areas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('beneficiario', models.ForeignKey(orm['core.beneficiario'], null=False)),
            ('area', models.ForeignKey(orm['core.area'], null=False))
        ))
        db.create_unique('core_beneficiario_areas', ['beneficiario_id', 'area_id'])
        ...
        # Adding field 'Usuario.nascimento'
        db.add_column('core_usuario', 'nascimento',
